...
class OlmoeRotaryEmbedding(nn.Module):
    ...
    def __init__(self, config: configuration_olmoe.OlmoeInterventionsConfig, device=None):
        super().__init__()
    ...
    def compute_default_rope_parameters(
        config: Optional[configuration_olmoe.OlmoeInterventionsConfig] = None,
...
class OlmoeAttention(nn.Module):
    ...
    def __init__(self, config: configuration_olmoe.OlmoeInterventionsConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class OlmoeModel(OlmoePreTrainedModel):
    def __init__(self, config: configuration_olmoe.OlmoeInterventionsConfig):
