    ...
    def set_activation_checkpointing(
        ...
        if strategy == ActivationCheckpointingStrategy.fine_grained:
            self._activation_checkpoint_fn = (
                checkpoint_func or activation_checkpoint_function(self.config)
            )
        else:
...
class OLMo(nn.Module):
    ...
    def reset_parameters(self):
        ...
        init_normal(
            self.transformer.wte, std=wte_std, init_cutoff_factor=wte_cutoff_factor
        )
        ...
        if hasattr(self.transformer, "wpe"):
            ...
            init_normal(
                self.transformer.wpe, std=wpe_std, init_cutoff_factor=wpe_cutoff_factor
            )
